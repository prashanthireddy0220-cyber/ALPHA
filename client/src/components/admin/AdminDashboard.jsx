...
import {
  ...
  PieChart, ChevronDown, ChevronUp, Image as ImageIcon
} from 'lucide-react';
...
export const AdminDashboard = () => {
  ...
  if (loading || !analytics) {
    return (
      <div className="p-12 text-center text-slate-400 space-y-4">
        ...
        <p className="text-xs font-bold uppercase tracking-widest text-red-400">LOADING ALPHA ADMIN CONTROL CENTER...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {/* ============================================================== */}
      {/* 1. TOP HEADER & DASHBOARD CONTROL BAR (From Reference Picture 1) */}
      {/* ============================================================== */}
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 border-b border-slate-800 pb-5">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="px-2.5 py-0.5 rounded-full bg-red-500/20 text-red-400 border border-red-500/40 text-[10px] font-extrabold tracking-widest uppercase flex items-center gap-1">
              <ShieldCheck className="w-3.5 h-3.5" />
              <span>ALPHA CONTROL CENTER</span>
            </span>
          </div>
          <h1 className="text-2xl md:text-3xl font-black text-white tracking-wide">ADMIN DASHBOARD</h1>
          <p className="text-xs text-slate-400">ALPHA 2026 MANAGEMENT PORTAL</p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-3.5 py-2 rounded-xl glass-button text-xs font-bold text-slate-300 hover:text-white flex items-center gap-1.5"
          >
            <span>VIEW PUBLIC SITE</span>
            <ExternalLink className="w-3.5 h-3.5" />
          </a>

          <div className="px-4 py-2 rounded-xl bg-red-600 text-white font-black text-xs tracking-wider flex items-center gap-1.5 shadow-[0_0_20px_rgba(239,68,68,0.5)]">
          ...
          <button
            ...
            className="px-3.5 py-2 rounded-xl glass-button text-xs font-bold text-slate-200 hover:text-white flex items-center gap-1.5 cursor-pointer"
          >
          ...
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-xs font-bold tracking-wider flex items-center gap-1.5 cursor-pointer border ${
      ...
      {/* ============================================================== */}
      {/* 2. TOP METRICS GRID - 8 METRIC CARDS (From Reference Picture 1) */}
      {/* ============================================================== */}
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-3">
        {/* Card 1: TOTAL TEAMS */}
        <div className="p-3.5 rounded-2xl glass-card border border-sky-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">TOTAL TEAMS</span>
          <div className="text-xl font-black text-white font-mono mt-1">{stats.totalTeams}</div>
        </div>

        {/* Card 2: CONFIRMED */}
        <div className="p-3.5 rounded-2xl glass-card border border-emerald-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">CONFIRMED</span>
          <div className="text-xl font-black text-emerald-400 font-mono mt-1">{stats.confirmedTeams}</div>
        </div>

        {/* Card 3: RESERVATIONS */}
        <div className="p-3.5 rounded-2xl glass-card border border-amber-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">RESERVATIONS</span>
          <div className="text-xl font-black text-amber-400 font-mono mt-1">{stats.activeReservations}</div>
        </div>

        {/* Card 4: AVAILABLE */}
        <div className="p-3.5 rounded-2xl glass-card border border-cyan-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">AVAILABLE</span>
          <div className="text-xl font-black text-cyan-400 font-mono mt-1">{stats.availableSlots}</div>
        </div>

        {/* Card 5: PARTICIPANTS */}
        <div className="p-3.5 rounded-2xl glass-card border border-indigo-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">PARTICIPANTS</span>
          <div className="text-xl font-black text-indigo-300 font-mono mt-1">{stats.totalParticipants}</div>
        </div>

        {/* Card 6: PENDING */}
        <div className="p-3.5 rounded-2xl glass-card border border-amber-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">PENDING</span>
          <div className="text-xl font-black text-amber-300 font-mono mt-1">{stats.pendingCount}</div>
        </div>

        {/* Card 7: VERIFIED */}
        <div className="p-3.5 rounded-2xl glass-card border border-emerald-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">VERIFIED</span>
          <div className="text-xl font-black text-emerald-300 font-mono mt-1">{stats.verifiedCount}</div>
        </div>

        {/* Card 8: REJECTED */}
        <div className="p-3.5 rounded-2xl glass-card border border-red-500/30 bg-slate-950/80 shadow-md">
          <span className="text-[9px] font-bold text-slate-400 block uppercase tracking-wider">REJECTED</span>
          <div className="text-xl font-black text-red-400 font-mono mt-1">{stats.rejectedCount}</div>
        </div>
      </div>

      {/* ============================================================== */}
      {/* 3. REGISTRATION DEMOGRAPHICS ANALYTICS (From Reference Picture 1) */}
      {/* ============================================================== */}
      <div className="p-5 rounded-3xl glass-card border border-sky-500/30 bg-slate-950/90 shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          ...
          <button
            ...
            className="text-[10px] font-extrabold text-slate-400 hover:text-white uppercase tracking-wider flex items-center gap-1 glass-button px-3 py-1 rounded-xl"
          >
        ...
        {showCharts && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 pt-1">
            ...
            <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex flex-col justify-between items-center text-center space-y-3">
              ...
              <div className="w-full text-[10px] space-y-1 font-semibold text-slate-300 pt-2 border-t border-slate-800">
                {yearBreakdown?.map((yb, idx) => (
                  <div key={idx} className="flex justify-between items-center">
                    <span className="flex items-center gap-1.5">
                      <span className={`w-2 h-2 rounded-full ${idx === 0 ? 'bg-red-500' : 'bg-blue-500'}`} />
                      <span>{yb.name}</span>
                    </span>
                    <span className="font-mono text-white">{yb.count} ({Math.round((yb.count / Math.max(1, stats.totalParticipants)) * 100)}%)</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="w-full text-[10px] space-y-1 font-semibold text-slate-300 pt-2 border-t border-slate-800">
                {genderBreakdown?.map((gb, idx) => (
                  <div key={idx} className="flex justify-between items-center">
                    ...
                    <span className="font-mono text-white">{gb.count} ({Math.round((gb.count / Math.max(1, stats.totalParticipants)) * 100)}%)</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-900/80 border border-slate-800 flex flex-col justify-between items-center text-center space-y-3">
              ...
              <div className="w-full text-[10px] space-y-1 font-semibold text-slate-300 pt-2 border-t border-slate-800 max-h-20 overflow-y-auto pr-1">
                {departmentBreakdown?.map((db, idx) => (
                  <div key={idx} className="flex justify-between items-center">
                    <span className="flex items-center gap-1.5">
                      <span className={`w-2 h-2 rounded-full ${idx === 0 ? 'bg-red-500' : idx === 1 ? 'bg-cyan-400' : 'bg-emerald-400'}`} />
                      <span>{db.name}</span>
                    </span>
                    <span className="font-mono text-white">{db.count} ({Math.round((db.count / Math.max(1, stats.totalParticipants)) * 100)}%)</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="w-full text-[10px] space-y-1 font-semibold text-slate-300 pt-2 border-t border-slate-800">
                {accommodationBreakdown?.map((ab, idx) => (
                  <div key={idx} className="flex justify-between items-center">
                    ...
                    <span className="font-mono text-white">{ab.count} ({Math.round((ab.count / Math.max(1, stats.totalParticipants)) * 100)}%)</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* ============================================================== */}
      {/* 4. SEARCH, FILTERS & ACTION BUTTONS ROW (From Reference Picture 2) */}
      {/* ============================================================== */}
      <div className="space-y-3">
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-slate-950 text-xs text-white placeholder-slate-500 border border-slate-800 focus:border-red-500 focus:outline-none"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-black text-xs tracking-wider flex items-center gap-2 shadow-[0_0_20px_rgba(239,68,68,0.5)] transition-all cursor-pointer whitespace-nowrap"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2">
          <select
            ...
            className="px-3 py-2 rounded-xl bg-slate-950 text-xs font-bold text-white border border-slate-800 focus:outline-none"
          >
        ...
        <div className="flex flex-wrap items-center gap-2 pt-1">
          <button
            onClick={exportCSV}
            className="px-4 py-1.5 rounded-xl border border-red-500/50 text-red-400 hover:bg-red-500/10 text-xs font-extrabold tracking-wider transition-all cursor-pointer flex items-center gap-1.5"
          >
          ...
          <button
            ...
            className="px-4 py-1.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-extrabold tracking-wider transition-all cursor-pointer flex items-center gap-1.5 shadow-md"
          >
          ...
          <button
            onClick={exportCSV}
            className="px-4 py-1.5 rounded-xl bg-red-600 hover:bg-red-500 text-white text-xs font-extrabold tracking-wider transition-all cursor-pointer flex items-center gap-1.5 shadow-[0_0_15px_rgba(239,68,68,0.4)]"
          >
            <Download className="w-3.5 h-3.5" />
          ...
          <button
            onClick={() => window.print()}
            className="px-4 py-1.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-300 hover:text-white text-xs font-extrabold tracking-wider transition-all cursor-pointer flex items-center gap-1.5"
          >
      ...
      {/* ============================================================== */}
      {/* 5. TEAMS DATA TABLE WITH RED BORDER (From Reference Picture 2) */}
      {/* ============================================================== */}
      <div className="overflow-hidden rounded-2xl glass-card border border-red-500/40 shadow-[0_0_30px_rgba(239,68,68,0.15)] bg-slate-950/90">
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs text-slate-300">
            <thead className="bg-slate-950 text-red-400 font-extrabold uppercase tracking-wider border-b border-red-500/30">
              <tr>
              ...
              {filteredTeams.map((t) => {
                ...
                return (
                  <tr key={t._id} className="hover:bg-slate-900/60 transition-colors">
                    <td className="p-4 font-mono font-black text-red-500 tracking-wider">
                      {t.teamId}
                    </td>
                    ...
                    <td className="p-4">
                      <div className="flex items-center justify-center gap-1.5">
                        <button
                          ...
                          className="px-2.5 py-1 text-[11px] font-bold text-slate-300 bg-slate-900 border border-slate-700 hover:text-white rounded-lg flex items-center gap-1 cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 text-[11px] font-bold text-red-400 bg-red-950/40 border border-red-500/30 hover:bg-red-900/60 rounded-lg flex items-center gap-1 cursor-pointer"
                        >
      ...
      {/* ============================================================== */}
      {/* 6. GLOBAL HACKATHON SETTINGS MODAL (From Reference Picture 3) */}
      {/* ============================================================== */}
      {showSettingsModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
          <div className="max-w-2xl w-full p-6 md:p-8 rounded-3xl glass-card border border-red-500/40 bg-slate-950 shadow-[0_0_60px_rgba(239,68,68,0.3)] space-y-6">
            ...
            <form onSubmit={handleSaveSettings} className="space-y-5 text-xs text-left">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl bg-slate-900 border border-slate-800 text-white focus:border-red-500 focus:outline-none font-mono"
                />
              </div>
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-red-600 hover:bg-red-500 text-white font-black text-xs tracking-widest uppercase shadow-[0_0_25px_rgba(239,68,68,0.6)] cursor-pointer"
              >
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
          <div className="max-w-lg w-full p-6 rounded-3xl glass-card border border-red-500/40 bg-slate-950 shadow-2xl space-y-5">
            ...
            <form onSubmit={handleAddRegistration} className="space-y-4 text-xs text-left">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-800 text-white font-bold uppercase focus:border-red-500 focus:outline-none"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-800 text-white font-mono focus:border-red-500 focus:outline-none"
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                disabled={addingReg}
                className="w-full py-3.5 rounded-xl bg-red-600 hover:bg-red-500 text-white font-black text-xs tracking-wider uppercase cursor-pointer"
              >
      ...
      {inspectTeam && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
          <div className="max-w-3xl w-full p-6 md:p-8 rounded-3xl glass-card border border-red-500/40 bg-slate-950 shadow-2xl max-h-[90vh] overflow-y-auto space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div>
                <span className="text-[10px] font-extrabold text-red-500 uppercase tracking-widest block">AUDIT TEAM REGISTRATION</span>
            ...
            <div className="p-4 rounded-2xl bg-slate-900/60 border border-slate-800 grid grid-cols-1 md:grid-cols-2 gap-5 text-xs">
              <div>
                <h3 className="font-bold text-red-400 uppercase mb-2">Payment Audit Info</h3>
              ...
              <div>
                <h3 className="font-bold text-red-400 uppercase mb-2">Payment Screenshot Preview</h3>
      ...
      {editTeam && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
          <div className="max-w-md w-full p-6 rounded-3xl glass-card border border-red-500/40 bg-slate-950 shadow-2xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800">
      ...
      {/* ============================================================== */}
      {/* 10. EVENT PASS PREVIEW MODAL (From Reference Picture 4) */}
      {/* ============================================================== */}
      {passTeam && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md overflow-y-auto">
          <div className="max-w-2xl w-full p-6 md:p-8 rounded-3xl glass-card border border-red-500/40 bg-slate-950 shadow-[0_0_60px_rgba(239,68,68,0.3)] space-y-6">
            <div className="flex items-center justify-between pb-3 border-b border-slate-800 print:hidden">
              <span className="text-xs font-black text-red-500 uppercase tracking-wider">OFFICIAL ADMISSION PASS PREVIEW</span>
              <div className="flex items-center gap-3">
                <button
            ...
            <div className="p-6 rounded-3xl bg-slate-950 border border-slate-800 space-y-6 text-left relative overflow-hidden">
              <div className="flex justify-between items-start">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] font-bold text-red-400 tracking-wider">KARE IEEE EDUCATION SOCIETY</p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-1">
                  <span className="px-2.5 py-0.5 rounded-full bg-red-600 text-white font-extrabold text-[10px]">TEAM LEAD</span>
                  <span className="text-xs font-bold text-slate-300">{passTeam.members?.[0]?.name} ({passTeam.leadEmail})</span>
                </div>
                <div className="text-2xl font-black text-red-500 font-mono mt-2 tracking-wider">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  {passTeam.members?.map((m, idx) => (
                    <div
                      key={m._id || idx}
                      className={`p-3 rounded-xl border ${idx === 0 ? 'bg-red-950/20 border-red-500/40' : 'bg-slate-900 border-slate-800'}`}
                    >
                      <div className="flex justify-between items-center font-extrabold">
                        <span className="text-white">{idx + 1}. {m.name}</span>
                        <span className="font-mono text-red-400">{m.regNo}</span>
                      </div>
